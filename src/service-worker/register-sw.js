...
const SW_URL = 'https://localhost.paypal.com:8443/sdk/public/service-worker.js?';
...
// const initialDataBroadcast = new BroadcastChannel(INITIAL_DATA_CHANNEL_NAME);

// initialDataBroadcast.onmessage = (event) => {
//     const { data } = event;
//     if ( !data ) {
//         return;
//     }
...
// //   fetch('https://www.msmaster.qa.paypal.com/graphql', {
// //         method: 'POST',
// //         headers: {
// //           "x-paypal-internal-euat": "so5-oRGA0Xztg6sBp7H79W9m6khMDW-hrOZvwNGruC9yvY3GbLV0ynm8TfRAbvbT2Kpt6cFgy3I0V32t7ASNLFpCH8d17V4ZjYxhUMNcD9pxXNreSXwuPEnUk0llH0hdoneA_W",
...
// //       })
// //       .then((res) => res.json())
// //       .then((result) => console.log('mine', result))
// //       .catch((err) => console.log('mine', err));
// }
